...
/**
 * The hint after a failed publish, update or delete (REQUIREMENTS §17.11).
 ...
 */
export function gistErrorHint(error: FiddleError): 'hintOwnership' | 'hintConnectivity' | undefined {
  switch (error.code) {
