/**
 * The built-in theme as it's drawn now (REQUIREMENTS §17.12, §10): Lucent's
...
export function currentThemeSnapshot(root: HTMLElement = document.documentElement): ThemeSnapshot {
