const ADJECTIVES = [
  ...
  'dapper', 'eager', 'fancy', 'fluffy', 'gentle', 'giant', 'glossy', 'golden', 'happy', 'hidden',
  'humble', 'icy', 'jolly', 'kind', 'lively', 'lucky', 'mellow', 'mighty', 'misty', 'noble',
  'odd', 'polite', 'proud', 'quick', 'quiet', 'rapid', 'rusty', 'shiny', 'silent', 'silly',
  'sleepy', 'snappy', 'sturdy', 'sunny', 'swift', 'tidy', 'tiny', 'vivid', 'witty', 'zesty',
];

const NOUNS = [
  'badger', 'beacon', 'breeze', 'canyon', 'comet', 'cookie', 'crane', 'dolphin', 'ember', 'falcon',
  'fern', 'fjord', 'forest', 'gadget', 'garden', 'glacier', 'harbor', 'island', 'kettle', 'lagoon',
  'lantern', 'meadow', 'meteor', 'moose', 'nebula', 'otter', 'owl', 'panda', 'pebble', 'pepper',
  'planet', 'puffin', 'quartz', 'rabbit', 'raven', 'river', 'rocket', 'sparrow', 'spruce', 'squirrel',
  'summit', 'teapot', 'thunder', 'tiger', 'tulip', 'valley', 'violet', 'walrus', 'willow', 'zebra',
];
