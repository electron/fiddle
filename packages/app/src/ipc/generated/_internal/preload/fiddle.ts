...
export const Window: Partial<IWindowRenderer> = {
  ...
  ActivateMenuItem(id: MenuItemId) {
    return ipcRenderer.invoke($$ipcPrefix$$ + 'Window_$_ActivateMenuItem', id);
  },
...
export const Documents: Partial<IDocumentsRenderer> = {
  ...
  MoveFile(name: FileName, before: FileName | null) {
    return ipcRenderer.invoke($$ipcPrefix$$ + 'Documents_$_MoveFile', name, before);
  },
...
export const AppPlatform: Partial<IAppPlatformRenderer> = {
  ...
  ShouldOfferTour() {
    return ipcRenderer.invoke($$ipcPrefix$$ + 'AppPlatform_$_ShouldOfferTour');
  },
  SetTourDone() {
    return ipcRenderer.invoke($$ipcPrefix$$ + 'AppPlatform_$_SetTourDone');
  },
}
