 ...
 *
 * The iframe's `src` is computed once and never changes — its query
 * string carries only the *initial* theme settings. Any later theme
 * change is delivered via `postMessage` so the iframe can apply it
 * in place without reloading and losing run state.
 */
