export enum IpcEvents {
  ...
  FIDDLE_START = 'FIDDLE_START',
  FIDDLE_STOP = 'FIDDLE_STOP',
  ...
  INSTALLER_STATE_CHANGE_EVENT = 'INSTALLER_STATE_CHANGE_EVENT',
  DOWNLOAD_ELECTRON_CALLBACK = 'DOWNLOAD_ELECTRON_CALLBACK',
  SET_FIDDLE_RUNNING_STATE = 'SET_FIDDLE_RUNNING_STATE',
  PUSH_OUTPUT_TO_CONSOLE = 'PUSH_OUTPUT_TO_CONSOLE',
  INITIALIZE_FIDDLE_INSTALLER = 'INITIALIZE_FIDDLE_INSTALLER',
  INITIALIZE_FIDDLE_PROCESS = 'INITIALIZE_FIDDLE_PROCESS',
  UNINSTALL_ELECTRON_VERSION = 'UNINSTALL_ELECTRON_VERSION',
  DOWNLOAD_ELECTRON_VERSION = 'DOWNLOAD_ELECTRON_VERSION',
  INSTALL_ELECTRON_VERSION = 'INSTALL_ELECTRON_VERSION',
  GET_ELECTRON_VERSION_STATE = 'GET_ELECTRON_VERSION_STATE',
}
...
export const ipcMainEvents = [
  ...
  IpcEvents.FIDDLE_STOP,
  IpcEvents.INITIALIZE_FIDDLE_INSTALLER,
